...
public class Login extends javax.swing.JFrame {
    ...
    if(!exists){
        output = new BufferedWriter(new FileWriter(file));
           ...
           jTextField3.setText(result4);
    if(m.testConnection(jTextField2.getText(),jTextField1.getText(),jPasswordField1.getText(),jTextField3.getText()) == true){
        jTextField4.setBackground(Color.green);
        jTextField4.setText(" Connect OK");
    }else{
        jTextField4.setBackground(Color.red);
        jTextField4.setText(" Connect Feil");
    }
    }
    ...
    private void initComponents() {
        ...
        jLabel8.setFont(new java.awt.Font("KodchiangUPC", 1, 48)); // NOI18N
        jLabel8.setText("Engineering Jounal");
        ...
        setBounds((screenSize.width-490)/2, (screenSize.height-480)/2, 490, 480);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            SQLConnection m = new SQLConnection();
            /*Boolean b = m.testConnection(jTextField2.getText(),jTextField1.getText(),jPasswordField1.getText(),jTextField3.getText());
            ...
            if(m.testConnection(jTextField2.getText(),jTextField1.getText(),jPasswordField1.getText(),jTextField3.getText()) == true || (jTextField2.getText().equals("") && jTextField1.getText().equals("") && jPasswordField1.getText().equals("") && jTextField3.getText().equals(""))){
                jTextField4.setBackground(Color.green);
                jTextField4.setText(" Connect OK");
            }else{
                jTextField4.setBackground(Color.red);
