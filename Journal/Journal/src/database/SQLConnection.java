...
public class SQLConnection {
  ...
  int found=0; String msg="";
    ...
    String passSQL, username,urlLocal;
  public SQLConnection(){
      try {
        ...
        BufferedReader reader = new BufferedReader(new FileReader("C:/windows/journal.txt"));
        ...
        reader.close();
        String urlLocal2 = fileData.toString();
        System.out.println(urlLocal2);*/
        }
        catch(IOException e){
  ...
  public Connection startProgram(){
            String name="journal"; int found2 = 0;
            try {
  ...
  public String getUsername() throws SQLException{
    ...
    try {
      Class.forName("com.mysql.jdbc.Driver");
      String url ="jdbc:mysql://"+urlLocal+"/"+fn;
    ...
    public boolean testConnection(String urlLo,String username,String pass) {
    try {
      Class.forName("com.mysql.jdbc.Driver");
      String url ="jdbc:mysql://"+urlLo+"/";
